...
export interface TruecolorFg {
  /** Any attribute escapes (bold/italic) that preceded the color escape. */
  prefix: string;
  r: number;
  g: number;
  b: number;
...
export function parseTruecolorFg(escape: string): TruecolorFg | null {
...
export function truecolorFg(prefix: string, r: number, g: number, b: number): string {
